...
from src.classifier import PROVINCES, classify_and_filter
...
try:
    ...
    HAS_PYPINYIN = False
    logger.warning("⚠️ pypinyin未安装，拼音匹配功能不可用")
...
def match_channel_name(channel_name: str, demo_name: str) -> bool:
    if config.demo_match_mode == "exact":
...
def detect_province(channel_name: str) -> str:
    ...
    city_map = {
        ...
        "广州":"广东","深圳":"广东","佛山":"广东","东莞":"广东","中山":"广东","珠海":"广东","惠州":"广东","江门":"广东","汕头":"广东","湛江":"广东","茂名":"广东","肇庆":"广东",
        "杭州":"浙江","宁波":"浙江","温州":"浙江","嘉兴":"浙江","湖州":"浙江","绍兴":"浙江","金华":"浙江","衢州":"浙江","舟山":"浙江","台州":"浙江","丽水":"浙江",
        "南京":"江苏","苏州":"江苏","无锡":"江苏","常州":"江苏","徐州":"江苏","南通":"江苏","扬州":"江苏","镇江":"江苏","泰州":"江苏","盐城":"江苏","淮安":"江苏","连云港":"江苏","宿迁":"江苏",
        ...
        "成都":"四川","绵阳":"四川","德阳":"四川","宜宾":"四川","自贡":"四川","攀枝花":"四川","泸州":"四川","广元":"四川","遂宁":"四川","内江":"四川","乐山":"四川","南充":"四川","眉山":"四川","广安":"四川","达州":"四川","雅安":"四川","巴中":"四川","资阳":"四川",
...
def get_demo_category_for_province(province: str, demo_order: List[Tuple[str, str]]) -> str:
    if province == "港澳台":
        return "🌊港·澳·台"
    candidates = [f"☘️{province}频道", f"{province}频道", f"☘️{province}", f"{province}"]
